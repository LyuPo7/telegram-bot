...
import {-# SOURCE #-} StripeAPI.Types.ChatMember
...
data ChatMemberUpdated = ChatMemberUpdated {
  ...
  -- | new_chat_member: This object contains information about one member of a chat. Currently, the following 6 types of chat members are supported:
  , chatMemberUpdatedNewChatMember :: ChatMember
  -- | old_chat_member: This object contains information about one member of a chat. Currently, the following 6 types of chat members are supported:
