...
module StripeAPI.Types.InlineQueryResultDocument where
...
data InlineQueryResultDocumentMimeType' =
   InlineQueryResultDocumentMimeType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | InlineQueryResultDocumentMimeType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | InlineQueryResultDocumentMimeType'EnumApplicationPdf -- ^ Represents the JSON value @"application/pdf"@
  | InlineQueryResultDocumentMimeType'EnumApplicationZip -- ^ Represents the JSON value @"application/zip"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InlineQueryResultDocumentMimeType'
    where toJSON (InlineQueryResultDocumentMimeType'Other val) = val
          toJSON (InlineQueryResultDocumentMimeType'Typed val) = Data.Aeson.Types.ToJSON.toJSON val
          toJSON (InlineQueryResultDocumentMimeType'EnumApplicationPdf) = "application/pdf"
          toJSON (InlineQueryResultDocumentMimeType'EnumApplicationZip) = "application/zip"
instance Data.Aeson.Types.FromJSON.FromJSON InlineQueryResultDocumentMimeType'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "application/pdf" -> InlineQueryResultDocumentMimeType'EnumApplicationPdf
                                            | val GHC.Classes.== "application/zip" -> InlineQueryResultDocumentMimeType'EnumApplicationZip
                                            | GHC.Base.otherwise -> InlineQueryResultDocumentMimeType'Other val)
