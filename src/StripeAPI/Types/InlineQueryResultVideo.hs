...
-- | Defines the enum schema located at @components.schemas.InlineQueryResultVideo.properties.mime_type@ in the specification.
-- 
-- Mime type of the content of video url, “text\/html” or “video\/mp4”
data InlineQueryResultVideoMimeType' =
   InlineQueryResultVideoMimeType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | InlineQueryResultVideoMimeType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | InlineQueryResultVideoMimeType'EnumTextHtml -- ^ Represents the JSON value @"text/html"@
  | InlineQueryResultVideoMimeType'EnumVideoMp4 -- ^ Represents the JSON value @"video/mp4"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InlineQueryResultVideoMimeType'
    where toJSON (InlineQueryResultVideoMimeType'Other val) = val
          toJSON (InlineQueryResultVideoMimeType'Typed val) = Data.Aeson.Types.ToJSON.toJSON val
          toJSON (InlineQueryResultVideoMimeType'EnumTextHtml) = "text/html"
          toJSON (InlineQueryResultVideoMimeType'EnumVideoMp4) = "video/mp4"
instance Data.Aeson.Types.FromJSON.FromJSON InlineQueryResultVideoMimeType'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "text/html" -> InlineQueryResultVideoMimeType'EnumTextHtml
                                            | val GHC.Classes.== "video/mp4" -> InlineQueryResultVideoMimeType'EnumVideoMp4
                                            | GHC.Base.otherwise -> InlineQueryResultVideoMimeType'Other val)
