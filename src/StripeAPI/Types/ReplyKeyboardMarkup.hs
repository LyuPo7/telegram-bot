...
import {-# SOURCE #-} StripeAPI.Types.KeyboardButton
...
data ReplyKeyboardMarkup = ReplyKeyboardMarkup {
  ...
  -- * Minimum length of 1
  replyKeyboardMarkupInputFieldPlaceholder :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
...
instance Data.Aeson.Types.ToJSON.ToJSON ReplyKeyboardMarkup
    where toJSON obj = Data.Aeson.Types.Internal.object ("input_field_placeholder" Data.Aeson.Types.ToJSON..= replyKeyboardMarkupInputFieldPlaceholder obj : "keyboard" Data.Aeson.Types.ToJSON..= replyKeyboardMarkupKeyboard obj : "one_time_keyboard" Data.Aeson.Types.ToJSON..= replyKeyboardMarkupOneTimeKeyboard obj : "resize_keyboard" Data.Aeson.Types.ToJSON..= replyKeyboardMarkupResizeKeyboard obj : "selective" Data.Aeson.Types.ToJSON..= replyKeyboardMarkupSelective obj : GHC.Base.mempty)
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("input_field_placeholder" Data.Aeson.Types.ToJSON..= replyKeyboardMarkupInputFieldPlaceholder obj) GHC.Base.<> (("keyboard" Data.Aeson.Types.ToJSON..= replyKeyboardMarkupKeyboard obj) GHC.Base.<> (("one_time_keyboard" Data.Aeson.Types.ToJSON..= replyKeyboardMarkupOneTimeKeyboard obj) GHC.Base.<> (("resize_keyboard" Data.Aeson.Types.ToJSON..= replyKeyboardMarkupResizeKeyboard obj) GHC.Base.<> ("selective" Data.Aeson.Types.ToJSON..= replyKeyboardMarkupSelective obj)))))
instance Data.Aeson.Types.FromJSON.FromJSON ReplyKeyboardMarkup
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "ReplyKeyboardMarkup" (\obj -> ((((GHC.Base.pure ReplyKeyboardMarkup GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "input_field_placeholder")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "keyboard")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "one_time_keyboard")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "resize_keyboard")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "selective"))
...
mkReplyKeyboardMarkup :: [[KeyboardButton]] -- ^ 'replyKeyboardMarkupKeyboard'
  -> ReplyKeyboardMarkup
mkReplyKeyboardMarkup replyKeyboardMarkupKeyboard = ReplyKeyboardMarkup{replyKeyboardMarkupInputFieldPlaceholder = GHC.Maybe.Nothing,
                                                                        replyKeyboardMarkupKeyboard = replyKeyboardMarkupKeyboard,
