...
module StripeAPI.Types.InlineQueryResultMpeg4Gif where
...
data InlineQueryResultMpeg4GifThumbMimeType' =
   InlineQueryResultMpeg4GifThumbMimeType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | InlineQueryResultMpeg4GifThumbMimeType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | InlineQueryResultMpeg4GifThumbMimeType'EnumImageJpeg -- ^ Represents the JSON value @"image/jpeg"@
  | InlineQueryResultMpeg4GifThumbMimeType'EnumImageGif -- ^ Represents the JSON value @"image/gif"@
  | InlineQueryResultMpeg4GifThumbMimeType'EnumVideoMp4 -- ^ Represents the JSON value @"video/mp4"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InlineQueryResultMpeg4GifThumbMimeType'
    where toJSON (InlineQueryResultMpeg4GifThumbMimeType'Other val) = val
          toJSON (InlineQueryResultMpeg4GifThumbMimeType'Typed val) = Data.Aeson.Types.ToJSON.toJSON val
          toJSON (InlineQueryResultMpeg4GifThumbMimeType'EnumImageJpeg) = "image/jpeg"
          toJSON (InlineQueryResultMpeg4GifThumbMimeType'EnumImageGif) = "image/gif"
          toJSON (InlineQueryResultMpeg4GifThumbMimeType'EnumVideoMp4) = "video/mp4"
instance Data.Aeson.Types.FromJSON.FromJSON InlineQueryResultMpeg4GifThumbMimeType'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "image/jpeg" -> InlineQueryResultMpeg4GifThumbMimeType'EnumImageJpeg
                                            | val GHC.Classes.== "image/gif" -> InlineQueryResultMpeg4GifThumbMimeType'EnumImageGif
                                            | val GHC.Classes.== "video/mp4" -> InlineQueryResultMpeg4GifThumbMimeType'EnumVideoMp4
                                            | GHC.Base.otherwise -> InlineQueryResultMpeg4GifThumbMimeType'Other val)
