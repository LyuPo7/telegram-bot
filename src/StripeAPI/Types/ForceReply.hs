...
data ForceReply = ForceReply {
  ...
  -- * Minimum length of 1
  , forceReplyInputFieldPlaceholder :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
...
instance Data.Aeson.Types.ToJSON.ToJSON ForceReply
    where toJSON obj = Data.Aeson.Types.Internal.object ("force_reply" Data.Aeson.Types.ToJSON..= forceReplyForceReply obj : "input_field_placeholder" Data.Aeson.Types.ToJSON..= forceReplyInputFieldPlaceholder obj : "selective" Data.Aeson.Types.ToJSON..= forceReplySelective obj : GHC.Base.mempty)
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("force_reply" Data.Aeson.Types.ToJSON..= forceReplyForceReply obj) GHC.Base.<> (("input_field_placeholder" Data.Aeson.Types.ToJSON..= forceReplyInputFieldPlaceholder obj) GHC.Base.<> ("selective" Data.Aeson.Types.ToJSON..= forceReplySelective obj)))
instance Data.Aeson.Types.FromJSON.FromJSON ForceReply
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "ForceReply" (\obj -> ((GHC.Base.pure ForceReply GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "force_reply")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "input_field_placeholder")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "selective"))
...
mkForceReply forceReplyForceReply = ForceReply{forceReplyForceReply = forceReplyForceReply,
                                               forceReplyInputFieldPlaceholder = GHC.Maybe.Nothing,
