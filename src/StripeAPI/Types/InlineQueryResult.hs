...
module StripeAPI.Types.InlineQueryResult where
...
import {-# SOURCE #-} StripeAPI.Types.InlineQueryResultArticle
import {-# SOURCE #-} StripeAPI.Types.InlineQueryResultAudio
import {-# SOURCE #-} StripeAPI.Types.InlineQueryResultCachedAudio
import {-# SOURCE #-} StripeAPI.Types.InlineQueryResultCachedDocument
import {-# SOURCE #-} StripeAPI.Types.InlineQueryResultCachedGif
import {-# SOURCE #-} StripeAPI.Types.InlineQueryResultCachedMpeg4Gif
import {-# SOURCE #-} StripeAPI.Types.InlineQueryResultCachedPhoto
import {-# SOURCE #-} StripeAPI.Types.InlineQueryResultCachedSticker
import {-# SOURCE #-} StripeAPI.Types.InlineQueryResultCachedVideo
import {-# SOURCE #-} StripeAPI.Types.InlineQueryResultCachedVoice
import {-# SOURCE #-} StripeAPI.Types.InlineQueryResultContact
import {-# SOURCE #-} StripeAPI.Types.InlineQueryResultDocument
import {-# SOURCE #-} StripeAPI.Types.InlineQueryResultGame
import {-# SOURCE #-} StripeAPI.Types.InlineQueryResultGif
import {-# SOURCE #-} StripeAPI.Types.InlineQueryResultLocation
import {-# SOURCE #-} StripeAPI.Types.InlineQueryResultMpeg4Gif
import {-# SOURCE #-} StripeAPI.Types.InlineQueryResultPhoto
import {-# SOURCE #-} StripeAPI.Types.InlineQueryResultVenue
import {-# SOURCE #-} StripeAPI.Types.InlineQueryResultVideo
import {-# SOURCE #-} StripeAPI.Types.InlineQueryResultVoice
...
data InlineQueryResultMimeType' =
   InlineQueryResultMimeType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | InlineQueryResultMimeType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | InlineQueryResultMimeType'EnumApplicationPdf -- ^ Represents the JSON value @"application/pdf"@
  | InlineQueryResultMimeType'EnumApplicationZip -- ^ Represents the JSON value @"application/zip"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InlineQueryResultMimeType'
    where toJSON (InlineQueryResultMimeType'Other val) = val
          toJSON (InlineQueryResultMimeType'Typed val) = Data.Aeson.Types.ToJSON.toJSON val
          toJSON (InlineQueryResultMimeType'EnumApplicationPdf) = "application/pdf"
          toJSON (InlineQueryResultMimeType'EnumApplicationZip) = "application/zip"
instance Data.Aeson.Types.FromJSON.FromJSON InlineQueryResultMimeType'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "application/pdf" -> InlineQueryResultMimeType'EnumApplicationPdf
                                            | val GHC.Classes.== "application/zip" -> InlineQueryResultMimeType'EnumApplicationZip
                                            | GHC.Base.otherwise -> InlineQueryResultMimeType'Other val)
...
data InlineQueryResultThumbMimeType' =
   InlineQueryResultThumbMimeType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | InlineQueryResultThumbMimeType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | InlineQueryResultThumbMimeType'EnumImageJpeg -- ^ Represents the JSON value @"image/jpeg"@
  | InlineQueryResultThumbMimeType'EnumImageGif -- ^ Represents the JSON value @"image/gif"@
  | InlineQueryResultThumbMimeType'EnumVideoMp4 -- ^ Represents the JSON value @"video/mp4"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InlineQueryResultThumbMimeType'
    where toJSON (InlineQueryResultThumbMimeType'Other val) = val
          toJSON (InlineQueryResultThumbMimeType'Typed val) = Data.Aeson.Types.ToJSON.toJSON val
          toJSON (InlineQueryResultThumbMimeType'EnumImageJpeg) = "image/jpeg"
          toJSON (InlineQueryResultThumbMimeType'EnumImageGif) = "image/gif"
          toJSON (InlineQueryResultThumbMimeType'EnumVideoMp4) = "video/mp4"
instance Data.Aeson.Types.FromJSON.FromJSON InlineQueryResultThumbMimeType'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "image/jpeg" -> InlineQueryResultThumbMimeType'EnumImageJpeg
                                            | val GHC.Classes.== "image/gif" -> InlineQueryResultThumbMimeType'EnumImageGif
                                            | val GHC.Classes.== "video/mp4" -> InlineQueryResultThumbMimeType'EnumVideoMp4
                                            | GHC.Base.otherwise -> InlineQueryResultThumbMimeType'Other val)
