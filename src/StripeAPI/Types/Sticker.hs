...
import {-# SOURCE #-} StripeAPI.Types.MaskPosition
...
mkSticker :: Data.Text.Internal.Text -- ^ 'stickerFileId'
  ...
  -> GHC.Types.Bool -- ^ 'stickerIsVideo'
  -> GHC.Types.Int -- ^ 'stickerWidth'
  -> Sticker
mkSticker stickerFileId stickerFileUniqueId stickerHeight stickerIsAnimated stickerIsVideo stickerWidth = Sticker{stickerEmoji = GHC.Maybe.Nothing,
