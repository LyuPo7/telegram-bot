...
data InlineQueryResultGifThumbMimeType' =
   InlineQueryResultGifThumbMimeType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | InlineQueryResultGifThumbMimeType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | InlineQueryResultGifThumbMimeType'EnumImageJpeg -- ^ Represents the JSON value @"image/jpeg"@
  | InlineQueryResultGifThumbMimeType'EnumImageGif -- ^ Represents the JSON value @"image/gif"@
  | InlineQueryResultGifThumbMimeType'EnumVideoMp4 -- ^ Represents the JSON value @"video/mp4"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InlineQueryResultGifThumbMimeType'
    where toJSON (InlineQueryResultGifThumbMimeType'Other val) = val
          toJSON (InlineQueryResultGifThumbMimeType'Typed val) = Data.Aeson.Types.ToJSON.toJSON val
          toJSON (InlineQueryResultGifThumbMimeType'EnumImageJpeg) = "image/jpeg"
          toJSON (InlineQueryResultGifThumbMimeType'EnumImageGif) = "image/gif"
          toJSON (InlineQueryResultGifThumbMimeType'EnumVideoMp4) = "video/mp4"
instance Data.Aeson.Types.FromJSON.FromJSON InlineQueryResultGifThumbMimeType'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "image/jpeg" -> InlineQueryResultGifThumbMimeType'EnumImageJpeg
                                            | val GHC.Classes.== "image/gif" -> InlineQueryResultGifThumbMimeType'EnumImageGif
                                            | val GHC.Classes.== "video/mp4" -> InlineQueryResultGifThumbMimeType'EnumVideoMp4
                                            | GHC.Base.otherwise -> InlineQueryResultGifThumbMimeType'Other val)
