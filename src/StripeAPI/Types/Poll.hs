...
module StripeAPI.Types.Poll where
...
import {-# SOURCE #-} StripeAPI.Types.PollOption
...
mkPoll pollAllowsMultipleAnswers pollId pollIsAnonymous pollIsClosed pollOptions pollQuestion pollTotalVoterCount pollType = Poll{pollAllowsMultipleAnswers = pollAllowsMultipleAnswers,
                                                                                                                                  ...
                                                                                                                                  pollType = pollType}
-- | Defines the enum schema located at @components.schemas.Poll.properties.type@ in the specification.
-- 
-- Poll type, currently can be “regular” or “quiz”
data PollType' =
   PollType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PollType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PollType'EnumRegular -- ^ Represents the JSON value @"regular"@
  | PollType'EnumQuiz -- ^ Represents the JSON value @"quiz"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PollType'
    where toJSON (PollType'Other val) = val
          toJSON (PollType'Typed val) = Data.Aeson.Types.ToJSON.toJSON val
          toJSON (PollType'EnumRegular) = "regular"
          toJSON (PollType'EnumQuiz) = "quiz"
instance Data.Aeson.Types.FromJSON.FromJSON PollType'
    where parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "regular" -> PollType'EnumRegular
                                            | val GHC.Classes.== "quiz" -> PollType'EnumQuiz
                                            | GHC.Base.otherwise -> PollType'Other val)
