...
module StripeAPI.Operations.PostSetChatStickerSet where
...
postSetChatStickerSet :: forall m . StripeAPI.Common.MonadHTTP m => PostSetChatStickerSetRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostSetChatStickerSetResponse) -- ^ Monadic computation which returns the result of the operation
postSetChatStickerSet body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostSetChatStickerSetResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostSetChatStickerSetResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                             ...
                                                                                                                                                                             | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostSetChatStickerSetResponseDefault Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                    Error)
                                                                                                                                                                             | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "POST") (Data.Text.pack "/setChatStickerSet") GHC.Base.mempty (GHC.Maybe.Just body) StripeAPI.Common.RequestBodyEncodingJSON)
...
data PostSetChatStickerSetRequestBody = PostSetChatStickerSetRequestBody {
  ...
  postSetChatStickerSetRequestBodyChatId :: PostSetChatStickerSetRequestBodyChatId'Variants
...
mkPostSetChatStickerSetRequestBody :: PostSetChatStickerSetRequestBodyChatId'Variants -- ^ 'postSetChatStickerSetRequestBodyChatId'
...
data PostSetChatStickerSetRequestBodyChatId'Variants =
   PostSetChatStickerSetRequestBodyChatId'Int GHC.Types.Int
  | PostSetChatStickerSetRequestBodyChatId'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostSetChatStickerSetRequestBodyChatId'Variants
    where toJSON (PostSetChatStickerSetRequestBodyChatId'Int a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (PostSetChatStickerSetRequestBodyChatId'Text a) = Data.Aeson.Types.ToJSON.toJSON a
instance Data.Aeson.Types.FromJSON.FromJSON PostSetChatStickerSetRequestBodyChatId'Variants
    where parseJSON val = case (PostSetChatStickerSetRequestBodyChatId'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PostSetChatStickerSetRequestBodyChatId'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
