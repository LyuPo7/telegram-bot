...
module StripeAPI.Operations.PostSendGame where
...
postSendGame :: forall m . StripeAPI.Common.MonadHTTP m => PostSendGameRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostSendGameResponse) -- ^ Monadic computation which returns the result of the operation
postSendGame body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostSendGameResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostSendGameResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                           ...
                                                                                                                                                           | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostSendGameResponseDefault Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                         Error)
                                                                                                                                                           | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "POST") (Data.Text.pack "/sendGame") GHC.Base.mempty (GHC.Maybe.Just body) StripeAPI.Common.RequestBodyEncodingJSON)
...
data PostSendGameRequestBody = PostSendGameRequestBody {
  ...
  , postSendGameRequestBodyProtectContent :: (GHC.Maybe.Maybe GHC.Types.Bool)
...
instance Data.Aeson.Types.ToJSON.ToJSON PostSendGameRequestBody
    where toJSON obj = Data.Aeson.Types.Internal.object ("allow_sending_without_reply" Data.Aeson.Types.ToJSON..= postSendGameRequestBodyAllowSendingWithoutReply obj : "chat_id" Data.Aeson.Types.ToJSON..= postSendGameRequestBodyChatId obj : "disable_notification" Data.Aeson.Types.ToJSON..= postSendGameRequestBodyDisableNotification obj : "game_short_name" Data.Aeson.Types.ToJSON..= postSendGameRequestBodyGameShortName obj : "protect_content" Data.Aeson.Types.ToJSON..= postSendGameRequestBodyProtectContent obj : "reply_markup" Data.Aeson.Types.ToJSON..= postSendGameRequestBodyReplyMarkup obj : "reply_to_message_id" Data.Aeson.Types.ToJSON..= postSendGameRequestBodyReplyToMessageId obj : GHC.Base.mempty)
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("allow_sending_without_reply" Data.Aeson.Types.ToJSON..= postSendGameRequestBodyAllowSendingWithoutReply obj) GHC.Base.<> (("chat_id" Data.Aeson.Types.ToJSON..= postSendGameRequestBodyChatId obj) GHC.Base.<> (("disable_notification" Data.Aeson.Types.ToJSON..= postSendGameRequestBodyDisableNotification obj) GHC.Base.<> (("game_short_name" Data.Aeson.Types.ToJSON..= postSendGameRequestBodyGameShortName obj) GHC.Base.<> (("protect_content" Data.Aeson.Types.ToJSON..= postSendGameRequestBodyProtectContent obj) GHC.Base.<> (("reply_markup" Data.Aeson.Types.ToJSON..= postSendGameRequestBodyReplyMarkup obj) GHC.Base.<> ("reply_to_message_id" Data.Aeson.Types.ToJSON..= postSendGameRequestBodyReplyToMessageId obj)))))))
instance Data.Aeson.Types.FromJSON.FromJSON PostSendGameRequestBody
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "PostSendGameRequestBody" (\obj -> ((((((GHC.Base.pure PostSendGameRequestBody GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "allow_sending_without_reply")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "chat_id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "disable_notification")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "game_short_name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "protect_content")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "reply_markup")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "reply_to_message_id"))
...
mkPostSendGameRequestBody postSendGameRequestBodyChatId postSendGameRequestBodyGameShortName = PostSendGameRequestBody{postSendGameRequestBodyAllowSendingWithoutReply = GHC.Maybe.Nothing,
                                                                                                                       ...
                                                                                                                       postSendGameRequestBodyProtectContent = GHC.Maybe.Nothing,
