...
module StripeAPI.Operations.PostPromoteChatMember where
...
postPromoteChatMember :: forall m . StripeAPI.Common.MonadHTTP m => PostPromoteChatMemberRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostPromoteChatMemberResponse) -- ^ Monadic computation which returns the result of the operation
postPromoteChatMember body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostPromoteChatMemberResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostPromoteChatMemberResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                             ...
                                                                                                                                                                             | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostPromoteChatMemberResponseDefault Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                    Error)
                                                                                                                                                                             | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "POST") (Data.Text.pack "/promoteChatMember") GHC.Base.mempty (GHC.Maybe.Just body) StripeAPI.Common.RequestBodyEncodingJSON)
...
data PostPromoteChatMemberRequestBody = PostPromoteChatMemberRequestBody {
  ...
  , postPromoteChatMemberRequestBodyChatId :: PostPromoteChatMemberRequestBodyChatId'Variants
...
mkPostPromoteChatMemberRequestBody :: PostPromoteChatMemberRequestBodyChatId'Variants -- ^ 'postPromoteChatMemberRequestBodyChatId'
...
data PostPromoteChatMemberRequestBodyChatId'Variants =
   PostPromoteChatMemberRequestBodyChatId'Int GHC.Types.Int
  | PostPromoteChatMemberRequestBodyChatId'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostPromoteChatMemberRequestBodyChatId'Variants
    where toJSON (PostPromoteChatMemberRequestBodyChatId'Int a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (PostPromoteChatMemberRequestBodyChatId'Text a) = Data.Aeson.Types.ToJSON.toJSON a
instance Data.Aeson.Types.FromJSON.FromJSON PostPromoteChatMemberRequestBodyChatId'Variants
    where parseJSON val = case (PostPromoteChatMemberRequestBodyChatId'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PostPromoteChatMemberRequestBodyChatId'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
