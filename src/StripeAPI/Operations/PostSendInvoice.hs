...
module StripeAPI.Operations.PostSendInvoice where
...
postSendInvoice :: forall m . StripeAPI.Common.MonadHTTP m => PostSendInvoiceRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostSendInvoiceResponse) -- ^ Monadic computation which returns the result of the operation
postSendInvoice body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostSendInvoiceResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostSendInvoiceResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                 ...
                                                                                                                                                                 | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostSendInvoiceResponseDefault Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                  Error)
                                                                                                                                                                 | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "POST") (Data.Text.pack "/sendInvoice") GHC.Base.mempty (GHC.Maybe.Just body) StripeAPI.Common.RequestBodyEncodingJSON)
...
data PostSendInvoiceRequestBody = PostSendInvoiceRequestBody {
  ...
  , postSendInvoiceRequestBodyChatId :: PostSendInvoiceRequestBodyChatId'Variants
  ...
  , postSendInvoiceRequestBodyProtectContent :: (GHC.Maybe.Maybe GHC.Types.Bool)
...
mkPostSendInvoiceRequestBody postSendInvoiceRequestBodyChatId postSendInvoiceRequestBodyCurrency postSendInvoiceRequestBodyDescription postSendInvoiceRequestBodyPayload postSendInvoiceRequestBodyPrices postSendInvoiceRequestBodyProviderToken postSendInvoiceRequestBodyTitle = PostSendInvoiceRequestBody{postSendInvoiceRequestBodyAllowSendingWithoutReply = GHC.Maybe.Nothing,
                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                               postSendInvoiceRequestBodyProtectContent = GHC.Maybe.Nothing,
...
data PostSendInvoiceRequestBodyChatId'Variants =
   PostSendInvoiceRequestBodyChatId'Int GHC.Types.Int
  | PostSendInvoiceRequestBodyChatId'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostSendInvoiceRequestBodyChatId'Variants
    where toJSON (PostSendInvoiceRequestBodyChatId'Int a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (PostSendInvoiceRequestBodyChatId'Text a) = Data.Aeson.Types.ToJSON.toJSON a
instance Data.Aeson.Types.FromJSON.FromJSON PostSendInvoiceRequestBodyChatId'Variants
    where parseJSON val = case (PostSendInvoiceRequestBodyChatId'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PostSendInvoiceRequestBodyChatId'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
