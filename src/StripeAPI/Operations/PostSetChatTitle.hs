...
module StripeAPI.Operations.PostSetChatTitle where
...
postSetChatTitle :: forall m . StripeAPI.Common.MonadHTTP m => PostSetChatTitleRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostSetChatTitleResponse) -- ^ Monadic computation which returns the result of the operation
postSetChatTitle body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostSetChatTitleResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostSetChatTitleResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                   ...
                                                                                                                                                                   | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostSetChatTitleResponseDefault Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                     Error)
                                                                                                                                                                   | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "POST") (Data.Text.pack "/setChatTitle") GHC.Base.mempty (GHC.Maybe.Just body) StripeAPI.Common.RequestBodyEncodingJSON)
...
data PostSetChatTitleRequestBody = PostSetChatTitleRequestBody {
  ...
  postSetChatTitleRequestBodyChatId :: PostSetChatTitleRequestBodyChatId'Variants
...
mkPostSetChatTitleRequestBody :: PostSetChatTitleRequestBodyChatId'Variants -- ^ 'postSetChatTitleRequestBodyChatId'
...
data PostSetChatTitleRequestBodyChatId'Variants =
   PostSetChatTitleRequestBodyChatId'Int GHC.Types.Int
  | PostSetChatTitleRequestBodyChatId'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostSetChatTitleRequestBodyChatId'Variants
    where toJSON (PostSetChatTitleRequestBodyChatId'Int a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (PostSetChatTitleRequestBodyChatId'Text a) = Data.Aeson.Types.ToJSON.toJSON a
instance Data.Aeson.Types.FromJSON.FromJSON PostSetChatTitleRequestBodyChatId'Variants
    where parseJSON val = case (PostSetChatTitleRequestBodyChatId'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PostSetChatTitleRequestBodyChatId'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
