...
module StripeAPI.Operations.PostGetChat where
...
postGetChat :: forall m . StripeAPI.Common.MonadHTTP m => PostGetChatRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostGetChatResponse) -- ^ Monadic computation which returns the result of the operation
postGetChat body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostGetChatResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostGetChatResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                         ...
                                                                                                                                                         | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostGetChatResponseDefault Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                      Error)
                                                                                                                                                         | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "POST") (Data.Text.pack "/getChat") GHC.Base.mempty (GHC.Maybe.Just body) StripeAPI.Common.RequestBodyEncodingJSON)
...
data PostGetChatRequestBody = PostGetChatRequestBody {
  ...
  postGetChatRequestBodyChatId :: PostGetChatRequestBodyChatId'Variants
...
mkPostGetChatRequestBody :: PostGetChatRequestBodyChatId'Variants -- ^ 'postGetChatRequestBodyChatId'
...
data PostGetChatRequestBodyChatId'Variants =
   PostGetChatRequestBodyChatId'Int GHC.Types.Int
  | PostGetChatRequestBodyChatId'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostGetChatRequestBodyChatId'Variants
    where toJSON (PostGetChatRequestBodyChatId'Int a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (PostGetChatRequestBodyChatId'Text a) = Data.Aeson.Types.ToJSON.toJSON a
instance Data.Aeson.Types.FromJSON.FromJSON PostGetChatRequestBodyChatId'Variants
    where parseJSON val = case (PostGetChatRequestBodyChatId'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PostGetChatRequestBodyChatId'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
