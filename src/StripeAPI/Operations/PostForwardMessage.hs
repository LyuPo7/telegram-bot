...
module StripeAPI.Operations.PostForwardMessage where
...
postForwardMessage :: forall m . StripeAPI.Common.MonadHTTP m => PostForwardMessageRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostForwardMessageResponse) -- ^ Monadic computation which returns the result of the operation
postForwardMessage body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostForwardMessageResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostForwardMessageResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                       ...
                                                                                                                                                                       | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostForwardMessageResponseDefault Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                           Error)
                                                                                                                                                                       | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "POST") (Data.Text.pack "/forwardMessage") GHC.Base.mempty (GHC.Maybe.Just body) StripeAPI.Common.RequestBodyEncodingJSON)
...
data PostForwardMessageRequestBody = PostForwardMessageRequestBody {
  ...
  postForwardMessageRequestBodyChatId :: PostForwardMessageRequestBodyChatId'Variants
  ...
  , postForwardMessageRequestBodyFromChatId :: PostForwardMessageRequestBodyFromChatId'Variants
  ...
  , postForwardMessageRequestBodyProtectContent :: (GHC.Maybe.Maybe GHC.Types.Bool)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostForwardMessageRequestBody
    where toJSON obj = Data.Aeson.Types.Internal.object ("chat_id" Data.Aeson.Types.ToJSON..= postForwardMessageRequestBodyChatId obj : "disable_notification" Data.Aeson.Types.ToJSON..= postForwardMessageRequestBodyDisableNotification obj : "from_chat_id" Data.Aeson.Types.ToJSON..= postForwardMessageRequestBodyFromChatId obj : "message_id" Data.Aeson.Types.ToJSON..= postForwardMessageRequestBodyMessageId obj : "protect_content" Data.Aeson.Types.ToJSON..= postForwardMessageRequestBodyProtectContent obj : GHC.Base.mempty)
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("chat_id" Data.Aeson.Types.ToJSON..= postForwardMessageRequestBodyChatId obj) GHC.Base.<> (("disable_notification" Data.Aeson.Types.ToJSON..= postForwardMessageRequestBodyDisableNotification obj) GHC.Base.<> (("from_chat_id" Data.Aeson.Types.ToJSON..= postForwardMessageRequestBodyFromChatId obj) GHC.Base.<> (("message_id" Data.Aeson.Types.ToJSON..= postForwardMessageRequestBodyMessageId obj) GHC.Base.<> ("protect_content" Data.Aeson.Types.ToJSON..= postForwardMessageRequestBodyProtectContent obj)))))
instance Data.Aeson.Types.FromJSON.FromJSON PostForwardMessageRequestBody
    where parseJSON = Data.Aeson.Types.FromJSON.withObject "PostForwardMessageRequestBody" (\obj -> ((((GHC.Base.pure PostForwardMessageRequestBody GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "chat_id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "disable_notification")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "from_chat_id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "message_id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:? "protect_content"))
-- | Create a new 'PostForwardMessageRequestBody' with all required fields.
mkPostForwardMessageRequestBody :: PostForwardMessageRequestBodyChatId'Variants -- ^ 'postForwardMessageRequestBodyChatId'
  -> PostForwardMessageRequestBodyFromChatId'Variants -- ^ 'postForwardMessageRequestBodyFromChatId'
...
mkPostForwardMessageRequestBody postForwardMessageRequestBodyChatId postForwardMessageRequestBodyFromChatId postForwardMessageRequestBodyMessageId = PostForwardMessageRequestBody{postForwardMessageRequestBodyChatId = postForwardMessageRequestBodyChatId,
                                                                                                                                                                                   ...
                                                                                                                                                                                   postForwardMessageRequestBodyProtectContent = GHC.Maybe.Nothing}
...
data PostForwardMessageRequestBodyChatId'Variants =
   PostForwardMessageRequestBodyChatId'Int GHC.Types.Int
  | PostForwardMessageRequestBodyChatId'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostForwardMessageRequestBodyChatId'Variants
    where toJSON (PostForwardMessageRequestBodyChatId'Int a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (PostForwardMessageRequestBodyChatId'Text a) = Data.Aeson.Types.ToJSON.toJSON a
instance Data.Aeson.Types.FromJSON.FromJSON PostForwardMessageRequestBodyChatId'Variants
    where parseJSON val = case (PostForwardMessageRequestBodyChatId'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PostForwardMessageRequestBodyChatId'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data PostForwardMessageRequestBodyFromChatId'Variants =
   PostForwardMessageRequestBodyFromChatId'Int GHC.Types.Int
  | PostForwardMessageRequestBodyFromChatId'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostForwardMessageRequestBodyFromChatId'Variants
    where toJSON (PostForwardMessageRequestBodyFromChatId'Int a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (PostForwardMessageRequestBodyFromChatId'Text a) = Data.Aeson.Types.ToJSON.toJSON a
instance Data.Aeson.Types.FromJSON.FromJSON PostForwardMessageRequestBodyFromChatId'Variants
    where parseJSON val = case (PostForwardMessageRequestBodyFromChatId'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PostForwardMessageRequestBodyFromChatId'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                              Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a
                              Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a
