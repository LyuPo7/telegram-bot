...
module StripeAPI.Operations.PostStopPoll where
...
postStopPoll :: forall m . StripeAPI.Common.MonadHTTP m => PostStopPollRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostStopPollResponse) -- ^ Monadic computation which returns the result of the operation
postStopPoll body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostStopPollResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostStopPollResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                           ...
                                                                                                                                                           | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostStopPollResponseDefault Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                         Error)
                                                                                                                                                           | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "POST") (Data.Text.pack "/stopPoll") GHC.Base.mempty (GHC.Maybe.Just body) StripeAPI.Common.RequestBodyEncodingJSON)
...
data PostStopPollRequestBody = PostStopPollRequestBody {
  ...
  postStopPollRequestBodyChatId :: PostStopPollRequestBodyChatId'Variants
...
mkPostStopPollRequestBody :: PostStopPollRequestBodyChatId'Variants -- ^ 'postStopPollRequestBodyChatId'
...
data PostStopPollRequestBodyChatId'Variants =
   PostStopPollRequestBodyChatId'Int GHC.Types.Int
  | PostStopPollRequestBodyChatId'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostStopPollRequestBodyChatId'Variants
    where toJSON (PostStopPollRequestBodyChatId'Int a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (PostStopPollRequestBodyChatId'Text a) = Data.Aeson.Types.ToJSON.toJSON a
instance Data.Aeson.Types.FromJSON.FromJSON PostStopPollRequestBodyChatId'Variants
    where parseJSON val = case (PostStopPollRequestBodyChatId'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PostStopPollRequestBodyChatId'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
