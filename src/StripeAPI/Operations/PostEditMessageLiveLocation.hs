...
module StripeAPI.Operations.PostEditMessageLiveLocation where
...
postEditMessageLiveLocation :: forall m . StripeAPI.Common.MonadHTTP m => PostEditMessageLiveLocationRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostEditMessageLiveLocationResponse) -- ^ Monadic computation which returns the result of the operation
postEditMessageLiveLocation body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostEditMessageLiveLocationResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostEditMessageLiveLocationResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                         ...
                                                                                                                                                                                         | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostEditMessageLiveLocationResponseDefault Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                      Error)
                                                                                                                                                                                         | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "POST") (Data.Text.pack "/editMessageLiveLocation") GHC.Base.mempty (GHC.Maybe.Just body) StripeAPI.Common.RequestBodyEncodingJSON)
...
data PostEditMessageLiveLocationRequestBody = PostEditMessageLiveLocationRequestBody {
  ...
  postEditMessageLiveLocationRequestBodyChatId :: (GHC.Maybe.Maybe PostEditMessageLiveLocationRequestBodyChatId'Variants)
...
data PostEditMessageLiveLocationRequestBodyChatId'Variants =
   PostEditMessageLiveLocationRequestBodyChatId'Int GHC.Types.Int
  | PostEditMessageLiveLocationRequestBodyChatId'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostEditMessageLiveLocationRequestBodyChatId'Variants
    where toJSON (PostEditMessageLiveLocationRequestBodyChatId'Int a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (PostEditMessageLiveLocationRequestBodyChatId'Text a) = Data.Aeson.Types.ToJSON.toJSON a
instance Data.Aeson.Types.FromJSON.FromJSON PostEditMessageLiveLocationRequestBodyChatId'Variants
    where parseJSON val = case (PostEditMessageLiveLocationRequestBodyChatId'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PostEditMessageLiveLocationRequestBodyChatId'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data PostEditMessageLiveLocationResponseBody200 = PostEditMessageLiveLocationResponseBody200 {
  ...
  -- | result
  , postEditMessageLiveLocationResponseBody200Result :: PostEditMessageLiveLocationResponseBody200Result'Variants
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
...
mkPostEditMessageLiveLocationResponseBody200 :: GHC.Types.Bool -- ^ 'postEditMessageLiveLocationResponseBody200Ok'
  -> PostEditMessageLiveLocationResponseBody200Result'Variants -- ^ 'postEditMessageLiveLocationResponseBody200Result'
  -> PostEditMessageLiveLocationResponseBody200
...
-- 
-- 
data PostEditMessageLiveLocationResponseBody200Result'Variants =
   PostEditMessageLiveLocationResponseBody200Result'Message Message
  | PostEditMessageLiveLocationResponseBody200Result'Bool GHC.Types.Bool
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostEditMessageLiveLocationResponseBody200Result'Variants
    where toJSON (PostEditMessageLiveLocationResponseBody200Result'Message a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (PostEditMessageLiveLocationResponseBody200Result'Bool a) = Data.Aeson.Types.ToJSON.toJSON a
instance Data.Aeson.Types.FromJSON.FromJSON PostEditMessageLiveLocationResponseBody200Result'Variants
    where parseJSON val = case (PostEditMessageLiveLocationResponseBody200Result'Message Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PostEditMessageLiveLocationResponseBody200Result'Bool Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                              Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a
                              Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a
