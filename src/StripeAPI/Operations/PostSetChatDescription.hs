...
module StripeAPI.Operations.PostSetChatDescription where
...
postSetChatDescription :: forall m . StripeAPI.Common.MonadHTTP m => PostSetChatDescriptionRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostSetChatDescriptionResponse) -- ^ Monadic computation which returns the result of the operation
postSetChatDescription body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostSetChatDescriptionResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostSetChatDescriptionResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                               ...
                                                                                                                                                                               | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostSetChatDescriptionResponseDefault Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                       Error)
                                                                                                                                                                               | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "POST") (Data.Text.pack "/setChatDescription") GHC.Base.mempty (GHC.Maybe.Just body) StripeAPI.Common.RequestBodyEncodingJSON)
...
data PostSetChatDescriptionRequestBody = PostSetChatDescriptionRequestBody {
  ...
  postSetChatDescriptionRequestBodyChatId :: PostSetChatDescriptionRequestBodyChatId'Variants
...
mkPostSetChatDescriptionRequestBody :: PostSetChatDescriptionRequestBodyChatId'Variants -- ^ 'postSetChatDescriptionRequestBodyChatId'
...
data PostSetChatDescriptionRequestBodyChatId'Variants =
   PostSetChatDescriptionRequestBodyChatId'Int GHC.Types.Int
  | PostSetChatDescriptionRequestBodyChatId'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostSetChatDescriptionRequestBodyChatId'Variants
    where toJSON (PostSetChatDescriptionRequestBodyChatId'Int a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (PostSetChatDescriptionRequestBodyChatId'Text a) = Data.Aeson.Types.ToJSON.toJSON a
instance Data.Aeson.Types.FromJSON.FromJSON PostSetChatDescriptionRequestBodyChatId'Variants
    where parseJSON val = case (PostSetChatDescriptionRequestBodyChatId'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PostSetChatDescriptionRequestBodyChatId'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
