...
module StripeAPI.Operations.PostEditMessageMedia where
...
postEditMessageMedia :: forall m . StripeAPI.Common.MonadHTTP m => StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostEditMessageMediaResponse) -- ^ Monadic computation which returns the result of the operation
postEditMessageMedia = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostEditMessageMediaResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostEditMessageMediaResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                      ...
                                                                                                                                                                      | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostEditMessageMediaResponseDefault Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                            Error)
                                                                                                                                                                      | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "POST") (Data.Text.pack "/editMessageMedia") GHC.Base.mempty)
...
data PostEditMessageMediaResponseBody200 = PostEditMessageMediaResponseBody200 {
  ...
  -- | result
  , postEditMessageMediaResponseBody200Result :: PostEditMessageMediaResponseBody200Result'Variants
...
mkPostEditMessageMediaResponseBody200 :: GHC.Types.Bool -- ^ 'postEditMessageMediaResponseBody200Ok'
  -> PostEditMessageMediaResponseBody200Result'Variants -- ^ 'postEditMessageMediaResponseBody200Result'
  -> PostEditMessageMediaResponseBody200
...
-- 
-- 
data PostEditMessageMediaResponseBody200Result'Variants =
   PostEditMessageMediaResponseBody200Result'Message Message
  | PostEditMessageMediaResponseBody200Result'Bool GHC.Types.Bool
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostEditMessageMediaResponseBody200Result'Variants
    where toJSON (PostEditMessageMediaResponseBody200Result'Message a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (PostEditMessageMediaResponseBody200Result'Bool a) = Data.Aeson.Types.ToJSON.toJSON a
instance Data.Aeson.Types.FromJSON.FromJSON PostEditMessageMediaResponseBody200Result'Variants
    where parseJSON val = case (PostEditMessageMediaResponseBody200Result'Message Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PostEditMessageMediaResponseBody200Result'Bool Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
