...
module StripeAPI.Operations.PostUnbanChatMember where
...
postUnbanChatMember :: forall m . StripeAPI.Common.MonadHTTP m => PostUnbanChatMemberRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostUnbanChatMemberResponse) -- ^ Monadic computation which returns the result of the operation
postUnbanChatMember body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostUnbanChatMemberResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostUnbanChatMemberResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                         ...
                                                                                                                                                                         | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostUnbanChatMemberResponseDefault Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                              Error)
                                                                                                                                                                         | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "POST") (Data.Text.pack "/unbanChatMember") GHC.Base.mempty (GHC.Maybe.Just body) StripeAPI.Common.RequestBodyEncodingJSON)
...
data PostUnbanChatMemberRequestBody = PostUnbanChatMemberRequestBody {
  ...
  postUnbanChatMemberRequestBodyChatId :: PostUnbanChatMemberRequestBodyChatId'Variants
...
mkPostUnbanChatMemberRequestBody :: PostUnbanChatMemberRequestBodyChatId'Variants -- ^ 'postUnbanChatMemberRequestBodyChatId'
...
data PostUnbanChatMemberRequestBodyChatId'Variants =
   PostUnbanChatMemberRequestBodyChatId'Int GHC.Types.Int
  | PostUnbanChatMemberRequestBodyChatId'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostUnbanChatMemberRequestBodyChatId'Variants
    where toJSON (PostUnbanChatMemberRequestBodyChatId'Int a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (PostUnbanChatMemberRequestBodyChatId'Text a) = Data.Aeson.Types.ToJSON.toJSON a
instance Data.Aeson.Types.FromJSON.FromJSON PostUnbanChatMemberRequestBodyChatId'Variants
    where parseJSON val = case (PostUnbanChatMemberRequestBodyChatId'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PostUnbanChatMemberRequestBodyChatId'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
