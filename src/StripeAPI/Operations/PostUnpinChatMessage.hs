...
module StripeAPI.Operations.PostUnpinChatMessage where
...
postUnpinChatMessage :: forall m . StripeAPI.Common.MonadHTTP m => PostUnpinChatMessageRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostUnpinChatMessageResponse) -- ^ Monadic computation which returns the result of the operation
postUnpinChatMessage body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostUnpinChatMessageResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostUnpinChatMessageResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                           ...
                                                                                                                                                                           | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostUnpinChatMessageResponseDefault Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                 Error)
                                                                                                                                                                           | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "POST") (Data.Text.pack "/unpinChatMessage") GHC.Base.mempty (GHC.Maybe.Just body) StripeAPI.Common.RequestBodyEncodingJSON)
...
data PostUnpinChatMessageRequestBody = PostUnpinChatMessageRequestBody {
  ...
  postUnpinChatMessageRequestBodyChatId :: PostUnpinChatMessageRequestBodyChatId'Variants
...
mkPostUnpinChatMessageRequestBody :: PostUnpinChatMessageRequestBodyChatId'Variants -- ^ 'postUnpinChatMessageRequestBodyChatId'
...
data PostUnpinChatMessageRequestBodyChatId'Variants =
   PostUnpinChatMessageRequestBodyChatId'Int GHC.Types.Int
  | PostUnpinChatMessageRequestBodyChatId'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostUnpinChatMessageRequestBodyChatId'Variants
    where toJSON (PostUnpinChatMessageRequestBodyChatId'Int a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (PostUnpinChatMessageRequestBodyChatId'Text a) = Data.Aeson.Types.ToJSON.toJSON a
instance Data.Aeson.Types.FromJSON.FromJSON PostUnpinChatMessageRequestBodyChatId'Variants
    where parseJSON val = case (PostUnpinChatMessageRequestBodyChatId'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PostUnpinChatMessageRequestBodyChatId'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
